...
const SpecularButton = ({
  ...
  size = 'lg',
  radius = 12, // Adjusted default radius for modern PWA look
  tint = '#2563eb', // Default Blue-600
  tintOpacity = 1, // Solid by default
  blur = 0,
  textColor = '#ffffff', // Default white text
  lineColor = '#93c5fd', // Blue-300 highlight
  baseColor = '#1d4ed8', // Blue-700 base edge
  intensity = 1.2,
  shineSize = 10,
  shineFade = 40,
  thickness = 1.5,
  ...
  return (
    ...
    >
      ...
      <span className="relative z-[2] flex items-center justify-center h-full w-full">{children}</span>
    </Component>
  );
};
