# ADR 152: feat(ux): add tap-to-copy utility for Stellar public keys with haptic toast

## Context
This ADR addresses issue #152: feat(ux): add tap-to-copy utility for Stellar public keys with haptic toast.
