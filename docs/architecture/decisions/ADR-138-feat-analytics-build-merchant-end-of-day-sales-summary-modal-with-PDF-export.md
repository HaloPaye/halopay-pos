# ADR 138: feat(analytics): build merchant end-of-day sales summary modal with PDF export

## Context
This ADR addresses issue #138: feat(analytics): build merchant end-of-day sales summary modal with PDF export.
