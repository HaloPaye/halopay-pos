# ADR 151: chore(ci): enforce Lighthouse CI performance budgets on Pull Requests

## Context
This ADR addresses issue #151: chore(ci): enforce Lighthouse CI performance budgets on Pull Requests.
